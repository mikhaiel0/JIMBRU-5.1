...
"message": {
"groupInviteMessage": {
"groupJid": "919544846609-1628086590@g.us",
...
replay('Success in unbanning the group')
  ...
  let buttonsntnsfw = [
  { buttonId: `${command} on`, buttonText: { displayText: 'ʙᴀɴ' }, type: 1 },
  { buttonId: `${command} off`, buttonText: { displayText: 'ᴜɴʙᴀɴ' }, type: 1 }
  ]
...
replay('Success in turning off nsfw in this group')
  ...
  let buttonsntnsfw = [
  { buttonId: `${command} on`, buttonText: { displayText: 'ᴏɴ' }, type: 1 },
  { buttonId: `${command} off`, buttonText: { displayText: 'ᴏғғ' }, type: 1 }
  ]
  await JimbruOffical.sendButtonText(m.chat, buttonsntnsfw, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.botname}`, m)
  }
  }
...
caption: `❥︎ ʏᴏᴜᴛᴜʙᴇ ᴘʟᴀʏ ❥︎*
${global.themeemoji} ᴛɪᴛʟᴇ : ${anu.title}
${global.themeemoji} ᴅᴜʀᴀᴛɪᴏɴ: ${anu.timestamp}
${global.themeemoji} ᴀᴜᴛʜᴏʀ : ${anu.author.name}
${global.themeemoji} ᴜʀʟ : ${anu.url}`,
footer: `${global.botname}`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
...
var walb = [
        {buttonId: `.${command} ${q}`, buttonText: {displayText: `ɴᴇxᴛ✨`}, type: 1},        
        ]
      let wal = {
...
case 'lyrics': {
    ...
    reply(`
${themeemoji} ᴛɪᴛʟᴇ : *${result.title}*
${themeemoji} ᴀᴜᴛʜᴏʀ : ${result.author}
${themeemoji} ʟʏʀɪᴄs : ${result.lyrics}
${themeemoji} ᴜʀʟ : ${result.link}
`.trim())
}
break	
case 'react': { 
...
let txt = `*「 ${global.ownername}'s ʙʀᴏᴀᴅᴄᴀsᴛ」*\n\n${text}`
...
│ ❥︎ sound160
│ ❥︎ sound161
╰────────────────❋ཻུ۪۪⸙ ` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "ɪɴsᴛᴀɢʀᴀᴍ","url": `${website}`}},{"urlButton": {"displayText": "sᴄʀɪᴘᴛ","url": `${botscript}`}},{"quickReplyButton": {"displayText": "ᴅᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "ᴏᴡɴᴇʀ","id": 'owner'}}] )
break
case 'gamemenu':
if (isBan) return reply(mess.ban)
if (isBanChat) return reply(mess.banChat)
...
│ ❥︎ fliptext  [ ᴛᴇxᴛ ]
│ ❥︎ toletter [number]
╰────────────────❋ཻུ۪۪⸙ ` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "ɪɴsᴛᴀɢʀᴀᴍ","url": `${websitex}`}},{"urlButton": {"displayText": "sᴄʀɪᴘᴛ","url": `${botscript}`}},{"quickReplyButton": {"displayText": "ᴅᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "ᴏᴡɴᴇʀ","id": 'owner'}}] )
break
case 'databasemenu':
if (isBan) return reply(mess.ban)
if (isBanChat) return reply(mess.banChat)
...
│ ❥︎getmsg
│ ❥︎delmsg
╰────────────────❋ཻུ۪۪⸙ ` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "ʏᴏᴜᴛᴜʙᴇ","url": `${website}`}},{"urlButton": {"displayText": "sᴄʀɪᴘᴛ","url": `${botscript}`}},{"quickReplyButton": {"displayText": "ᴅᴏɴᴀᴛᴇ","id": 'donate'}},{"quickReplyButton": {"displayText": "ᴏᴡɴᴇʀ","id": 'owner'}}] )
break
case 'indomenu':
if (isBan) return reply(mess.ban)
if (isBanChat) return reply(mess.banChat)
